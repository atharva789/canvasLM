    ...
    return (
        <div className="flex items-center justify-center text-center h-[100vh] w-full">
            ...
            <div className="flex flex-col border border-slate-500 shadow shadow-slate-300 p-10">
                <div className="mb-10">
                    <p className="text-3xl text  ">Signup</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="submit" className="border border-slate-300 px-8 py-2 rounded-full cursor-pointer active:scale-95" value="Signup" />
